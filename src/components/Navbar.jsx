...
const Navbar = () => {
  ...
  return (
    <div>
        <nav className={`w-full flex  px-16 max-sm:px-10 justify-between items-center fixed navbar inset-x-0 bg-[#000000b3]   backdrop-filter backdrop-blur-xl bg-opacity-0 z-50  `}>

          <div className="bank__image">
        <img src={logo} alt="walletech" className="w-[124px] h-[128px]" />
     </div>
