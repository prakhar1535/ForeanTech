...
With ForeanTech you can manage your buisness / startup on go. You need a team we will provide you, you need monetary support we wil provide you investors. It just requires a great idea to start something big. What are you waiting for?</p>
</motion.div>
...
{/* gradient end */}
  ...
  >
      <h2 className={`flex text-[32px] max-lg:text-[32px] max-ss:text-[32px] max-[490px]:text-[30px] text-[#101010] font-larsseit  font-semibold tracking-wide justify-center`}>
        Fast and Effeicient way of building
      </h2></motion.div>
      <motion.div
    variants={sectionVariant}
    initial="hidden"
  ...
  >
      <div className="w-full md:mt-0 mt-6">
        <p className={` font-larsseit max-lg:text-[14px] max-[1060px]:justify-center mt-5 text-[#10101088] tracking-wide`}>
          ForeanTech can be your goto CA, development team as well as reasearch team <br />
          With ForeanTech your buissness will reach heights.
